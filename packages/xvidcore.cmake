ExternalProject_Add(xvidcore
    ...
    CONFIGURE_COMMAND ${EXEC} cd <SOURCE_DIR>/build/generic && CONF=1 CFLAGS='-std=gnu17' ./configure # running configure outside that directory will make it happily ignore --host while building
        --host=${TARGET_ARCH}
